...
-- 583 كائناً. لا تحرّره يدوياً: أعد التصدير بعد أي تغيير في القاعدة.
...
alter table iapp.audit_logs_2026_08 add constraint audit_logs_2026_08_pkey PRIMARY KEY (id, occurred_at);

alter table iapp.audit_logs_2026_08 add constraint audit_logs_action_check CHECK ((action = ANY (ARRAY['read'::text, 'create'::text, 'update'::text, 'delete'::text, 'login'::text, 'logout'::text, 'export'::text, 'print'::text, 'link'::text, 'ai_analyze'::text])));

alter table iapp.audit_logs_2026_08 add constraint audit_logs_outcome_check CHECK ((outcome = ANY (ARRAY['allow'::text, 'deny'::text, 'error'::text])));

alter table iapp.audit_logs_2026_09 add constraint audit_logs_2026_09_pkey PRIMARY KEY (id, occurred_at);

alter table iapp.audit_logs_2026_09 add constraint audit_logs_action_check CHECK ((action = ANY (ARRAY['read'::text, 'create'::text, 'update'::text, 'delete'::text, 'login'::text, 'logout'::text, 'export'::text, 'print'::text, 'link'::text, 'ai_analyze'::text])));

alter table iapp.audit_logs_2026_09 add constraint audit_logs_outcome_check CHECK ((outcome = ANY (ARRAY['allow'::text, 'deny'::text, 'error'::text])));

alter table iapp.audit_logs_2026_10 add constraint audit_logs_2026_10_pkey PRIMARY KEY (id, occurred_at);

alter table iapp.audit_logs_2026_10 add constraint audit_logs_action_check CHECK ((action = ANY (ARRAY['read'::text, 'create'::text, 'update'::text, 'delete'::text, 'login'::text, 'logout'::text, 'export'::text, 'print'::text, 'link'::text, 'ai_analyze'::text])));

alter table iapp.audit_logs_2026_10 add constraint audit_logs_outcome_check CHECK ((outcome = ANY (ARRAY['allow'::text, 'deny'::text, 'error'::text])));

alter table iapp.audit_logs_default add constraint audit_logs_action_check CHECK ((action = ANY (ARRAY['read'::text, 'create'::text, 'update'::text, 'delete'::text, 'login'::text, 'logout'::text, 'export'::text, 'print'::text, 'link'::text, 'ai_analyze'::text])));

alter table iapp.audit_logs_default add constraint audit_logs_default_pkey PRIMARY KEY (id, occurred_at);

alter table iapp.audit_logs_default add constraint audit_logs_outcome_check CHECK ((outcome = ANY (ARRAY['allow'::text, 'deny'::text, 'error'::text])));
...
alter table iapp.audit_logs_2026_08 add constraint audit_logs_actor_id_fkey FOREIGN KEY (actor_id) REFERENCES auth.users(id) ON DELETE SET NULL;

alter table iapp.audit_logs_2026_09 add constraint audit_logs_actor_id_fkey FOREIGN KEY (actor_id) REFERENCES auth.users(id) ON DELETE SET NULL;

alter table iapp.audit_logs_2026_10 add constraint audit_logs_actor_id_fkey FOREIGN KEY (actor_id) REFERENCES auth.users(id) ON DELETE SET NULL;

alter table iapp.audit_logs_default add constraint audit_logs_actor_id_fkey FOREIGN KEY (actor_id) REFERENCES auth.users(id) ON DELETE SET NULL;
